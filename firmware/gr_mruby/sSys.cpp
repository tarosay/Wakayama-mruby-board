...
void sys_Init(mrb_state *mrb)
{
	...
	mrb_define_module_function(mrb, systemModule, "version", mrb_system_version, ARGS_OPT(1));

	mrb_define_module_function(mrb, systemModule, "push", mrb_system_push, ARGS_REQ(3));
	mrb_define_module_function(mrb, systemModule, "pop", mrb_system_pop, ARGS_REQ(2));

	mrb_define_module_function(mrb, systemModule, "fileload", mrb_system_fileload, ARGS_NONE());
}
