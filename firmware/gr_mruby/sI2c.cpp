...
void i2c_Init(mrb_state *mrb)
{
	...
	mrb_define_module_function(mrb, i2cModule, "sdascl", mrb_i2c_SdaScl, ARGS_REQ(2));
	mrb_define_module_function(mrb, i2cModule, "write", mrb_i2c_write, ARGS_REQ(3));
	mrb_define_module_function(mrb, i2cModule, "read", mrb_i2c_read, ARGS_REQ(2)|ARGS_OPT(1));
	
	mrb_define_module_function(mrb, i2cModule, "begin", mrb_i2c_beginTransmission, ARGS_REQ(1));
	mrb_define_module_function(mrb, i2cModule, "lwrite", mrb_i2c_lwrite, ARGS_REQ(1));
	mrb_define_module_function(mrb, i2cModule, "end", mrb_i2c_endTransmission, ARGS_NONE());
	mrb_define_module_function(mrb, i2cModule, "request", mrb_i2c_requestFrom, ARGS_REQ(2));
	mrb_define_module_function(mrb, i2cModule, "lread", mrb_i2c_lread, ARGS_NONE());
	mrb_define_module_function(mrb, i2cModule, "freq", mrb_i2c_freq, ARGS_REQ(1));
}
