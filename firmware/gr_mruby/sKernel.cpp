...
void kernel_Init(mrb_state *mrb)
{
	...
	mrb_define_method(mrb, mrb->kernel_module, "pwm", mrb_kernel_pwm, ARGS_REQ(2));
	...
	mrb_define_method(mrb, mrb->kernel_module, "pwmHz", mrb_kernel_pwmHz, ARGS_REQ(1));
	mrb_define_method(mrb, mrb->kernel_module, "analogDac", mrb_kernel_analogDac, ARGS_REQ(1));
