...
void serial_Init(mrb_state *mrb)
{
	...
	mrb_define_module_function(mrb, serialModule, "begin", mrb_serial_begin, ARGS_REQ(2));
	mrb_define_module_function(mrb, serialModule, "setDefault", mrb_serial_setdefault, ARGS_REQ(2));
	mrb_define_module_function(mrb, serialModule, "print", mrb_serial_print, ARGS_REQ(1)|ARGS_OPT(1));
	mrb_define_module_function(mrb, serialModule, "println", mrb_serial_println, ARGS_REQ(1)|ARGS_OPT(1));

	mrb_define_module_function(mrb, serialModule, "read", mrb_serial_read, ARGS_REQ(1));
	mrb_define_module_function(mrb, serialModule, "write", mrb_serial_write, ARGS_REQ(3));
	mrb_define_module_function(mrb, serialModule, "available", mrb_serial_available, ARGS_REQ(1));

	mrb_define_module_function(mrb, serialModule, "end", mrb_serial_end, ARGS_REQ(1));
}
