...
void servo_Init(mrb_state *mrb)
{
	...
	mrb_define_module_function(mrb, servoModule, "attach", mrb_servo_attach, ARGS_REQ(2) | ARGS_OPT(2));
	mrb_define_module_function(mrb, servoModule, "write", mrb_servo_write, ARGS_REQ(2));
	mrb_define_module_function(mrb, servoModule, "us", mrb_servo_us, ARGS_REQ(2));
	mrb_define_module_function(mrb, servoModule, "read", mrb_servo_read, ARGS_REQ(1));
	mrb_define_module_function(mrb, servoModule, "attached", mrb_servo_attached, ARGS_REQ(1));
	mrb_define_module_function(mrb, servoModule, "detach", mrb_servo_detach, ARGS_REQ(1));
}
