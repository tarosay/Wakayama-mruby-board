...
void rtc_Init(mrb_state *mrb)
{
	...
	mrb_define_module_function(mrb, rtcModule, "begin", mrb_rtc_begin, ARGS_NONE());
	mrb_define_module_function(mrb, rtcModule, "setDateTime", mrb_rtc_setDateTime, ARGS_REQ(6));
	mrb_define_module_function(mrb, rtcModule, "getDateTime", mrb_rtc_getDateTime, ARGS_NONE());
}
